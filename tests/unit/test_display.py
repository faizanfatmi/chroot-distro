...
from chroot_distro.helpers.display import _resolve_dbus_env, resolve_display_env
...
@patch(
    "chroot_distro.helpers.display.resolve_wayland_env",
    return_value={"WAYLAND_DISPLAY": "wayland-0", "XDG_SESSION_TYPE": "wayland"},
)
@patch(
    "chroot_distro.helpers.display.resolve_sound_env", return_value={"PULSE_SERVER": "unix:/run/user/1000/pulse/native"}
)
@patch(
    "chroot_distro.helpers.display._resolve_dbus_env",
